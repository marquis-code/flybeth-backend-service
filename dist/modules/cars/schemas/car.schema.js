...
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: ['rental', 'ride'] }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ type: [String], default: [] }),
    __metadata("design:type", Array)
], Car.prototype, "availableLocations", void 0);
exports.Car = Car = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'cars' })
], Car);
exports.CarSchema = mongoose_1.SchemaFactory.createForClass(Car);
exports.CarSchema.index({ type: 1, availableLocations: 1 });
exports.CarSchema.index({ vendor: 1 });
exports.CarSchema.index({ category: 1 });
exports.CarSchema.index({ name: 'text', vendor: 'text' });
